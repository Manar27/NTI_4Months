/*
 ...
 Date		 : Oct 31, 2023
 Version	 : 1.0
 Description : CAN_private header file
 ============================================================================
*/
...
#define  	RIR_EXID      ((u32)0x1FFFFFFF)        // Extended identifier 							-- The LSBs of the extended identifier.
#define  	RIR_STID      ((u32)0x000007FF)        // Standard Identifier or Extended Identifier	-- The standard identifier or the MSBs of the extended identifier
