/*
 ...
 Date		 : Oct 31, 2023
 Version	 : 1.0
 Description : CAN_config source file
 ============================================================================
*/
#include "STD_TYPES.h"
...
CAN_FilterInit_t CAN_FilterAppDiagnostics = {(u32)(0X48<<21), (u32)(0X48<<21), CAN_FILTERMODE_IDLIST, 7, CAN_FILTERSCALE_32BIT, CAN_FIFO_0, CAN_ENABLE};
